      ...
      <Fragment>
        ...
        <section className={classes.sectionText}>
          ...
          <p>
            ...
            d&apos;utilisation, comme indiqué dans
            l&apos;Article&nbsp;L.&nbsp;112-9 du Code des relations entre le
            public et l&apos;administration.
          </p>

          <p>
            L&apos;utilisation d&apos;OPEN LexImpact requiert une connexion
            internet et un navigateur récent, OPEN LexImpact ne fonctionne pas
          ...
          <p>
            Lors de l&apos;utilisation du service, OPEN LexImpact ne vous
            demande ni ne stocke d&apos;information nominative telle que noms,
            prénoms ou adresses.
          </p>

          <p>
            Toutefois, nous mettons à disposition un formulaire de contact dans
            le cas où vous auriez une demande ou&nbsp;bien un retour
            d&apos;expérience à nous partager. Dans ce cadre, nous nous
            engageons à ne conserver que les données anonymisées de nos
            échanges. Ces informations nous permettront d&apos;améliorer le
            service. Toutes les données directement identifiantes (nom, adresse,
            …) seront supprimées dans un délai de un an.
          </p>
          ...
          <p>
            ...
            fois de l’interface OPEN LexImpact mais également des mises à jour
          ...
          <p>
            Nous pouvons faire évoluer OPEN LexImpact sans information
          ...
          <p>
            Nous pouvons suspendre l&apos;accès à OPEN LexImpact sans
            information préalable, notamment pour des raisons de maintenance.
