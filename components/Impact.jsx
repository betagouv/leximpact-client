                ...
                <Grid container spacing={24}>
                    {this.props.cas_types.map((ct, i) => (
                        ...
                        <Grid item key={i} xs={6} sm={12} md={6} lg={4} xl={3}>
                            <SimpleCard loading={loading} onChange={this.handleChangeRevenu} index={i} desc_cas_type={ct} impots_avant={res_brut.avant[i]} delta={res_brut.apres[i] - res_brut.avant[i]} />
                        </Grid>
                    ))}
