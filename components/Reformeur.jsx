  ...
  endpoint= () => {
    ...
    updateCompare(bodyreq){
      ...
      fetch(this.endpoint()+'/calculate/compare',{
          ...
          .then(response => response.json())
          .then(json => { this.setState({res_brut:json.res_brut,loading:false});})
    }
                          ...
                          if (matches) {
                                    ...
                                    {/*<div>You are sized like a tablet or mobile phone though</div>*/}
                                          <div className={classes.root}>
                                            ...
                                            >
                                                  ...
                                                  <TabContainer dir={theme.direction}>
                                                            <Impact loading={this.state.loading} onRevenuChange={this.handleRevenuChange} res_brut={this.state.res_brut}
                            ...
                            return (
                                <div>
                                    ...
                                    <div className="moitie-droite">
                                        <Impact loading={this.state.loading} onRevenuChange={this.handleRevenuChange} res_brut={this.state.res_brut} total_pop={this.state.total_pop}
