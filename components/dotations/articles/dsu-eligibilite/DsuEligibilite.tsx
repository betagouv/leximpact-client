    ...
    return (
      <Fragment>
        ...
        1° Les [deux premiers tiers] 66 premiers % des communes de 10 000 habitants et plus,
         classées, chaque année, en fonction d&apos;un indice synthétique de ressources et 
         de charges défini à l&apos;article L. 2334-17 ;
        <br />
        <br />
        2° Le [premier dixième] 10 premiers % des communes dont la population est comprise entre 5 000 
        et 9 999 habitants, classées, chaque année, en fonction d&apos;un indice synthétique de ressources 
